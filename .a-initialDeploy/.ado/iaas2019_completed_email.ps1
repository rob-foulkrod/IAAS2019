...
<td style="width: 33.3333%;">&nbsp;</td>
  ...
  <table border="1" cellpadding="0" cellspacing="0" class="logo" width="100%">              
    <tr>
    <br>
      <th>Deployment Parameters      </th>
      <th>Deployment Values</th>

    </tr>
    <tr>
      <td>VM Remote Connectivity</td>
      <td>RDP using <b>VM public IP-address</b> and user <b>labadmin</b></td>
     <tr>
      <td>AdminUsername</td>
      <td>$adminUsername</td>
    </tr>
